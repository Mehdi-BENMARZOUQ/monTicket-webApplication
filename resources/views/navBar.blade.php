@php
    ...
    $isActiveHome = $currentUrl === '/';
    $isActiveLike = $currentUrl === 'favorites';
    $isActiveTicket = $currentUrl === 'my-tickets';
    $isActiveTOnFire = $currentUrl === '';

    $classesHome = ($isActiveHome )
        ? 'active'
        : '';

    $classesLike  = ($isActiveLike )
        ? 'active'
        : '';

    $classesTicket = ($isActiveTicket )
        ? 'active'
        : '';

    $classesOnFire = ($isActiveTOnFire )
        ? 'active'
        : '';
                ...
                <div class="col-12 col-md-8 d-none d-xl-block">
                    <nav class="site-navigation position-relative text-right" role="navigation">
                        <ul class="site-menu js-clone-nav mr-auto d-none d-lg-block">
                            <li class="{{$classesHome }}"><a href="index.html"><span>Home</span></a></li>
                            ...
                            <li class="{{$classesLike }}"><a href="{{route('favorites.index')}}"  >
                                    <span>
                            ...
                            <li class="{{$classesTicket }}"><a href="{{route('myTickets.index')}}" >
                                    <span>
