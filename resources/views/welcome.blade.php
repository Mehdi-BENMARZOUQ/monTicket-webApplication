...
@include('navBar')
    ...
    <div class="site-section">
        <div class="container">
            ...
            <div class="row align-items-stretch my-3 fade-in" id="second-row" style="display: none;">
                <div class="col-6 col-sm-6 col-md-4 mb-4 mb-lg-0 col-lg-2">
                    <a href="{{ route('events.byCategory', 'FOOD & DRINK') }}" class="popular-category h-100">
                        <span class="icon mb-3">
                        ...
                        <span class="caption mb-2 d-block">Food & Drink</span>
                        <span class="number">692</span>
                    </a>
                </div>
                <div class="col-6 col-sm-6 col-md-4 mb-4 mb-lg-0 col-lg-2">
                    <a href="{{ route('events.byCategory', 'FESTIVALS') }}" class="popular-category h-100">
                        <span class="icon mb-3">
                        ...
                        <span class="caption mb-2 d-block">FESTIVALS</span>
                        <span class="number">692</span>
                    </a>
                </div>
            </div>
            ...
            <div class="row mt-5 justify-content-center tex-center">
                <div class="col-md-4" id="view-all-btn-wrapper"><button href="#" class="btn btn-block btn-outline-primary btn-md px-5" onclick="toggleSecondRow()">View All Categories</button></div>
            </div>
        </div>
    </div>
...
<script>
    ...
    function toggleSecondRow() {
        ...
        var isVisible = secondRow.style.display === "flex";
        var viewAllBtnWrapper = document.getElementById("view-all-btn-wrapper");
